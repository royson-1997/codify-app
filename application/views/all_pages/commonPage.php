...
<body style="position:relative;min-height:100%;font-family: 'Source Sans Pro', sans-serif;">
  ...
  <a class="w3-bar-item w3-button w3-hide-small barex bar-item-hover w3-padding-24" href="javascript:void(0)" onclick="w3_open_nav('tutorials')" id="navbtn_tutorials" title="Tutorials" style="width:116px">Tutorials <i class="fa fa-caret-down" style="display: inline;"></i><i class="fa fa-caret-up" style="display: none;"></i></a>
  <a class="w3-bar-item w3-button w3-hide-small barex bar-item-hover w3-padding-24" href="javascript:void(0)" onclick="w3_open_nav('references')" id="navbtn_references" title="References" style="width:132px">References <i class="fa fa-caret-down" style="display: inline;"></i><i class="fa fa-caret-up" style="display: none;"></i></a>
  ...
  <div id="loginactioncontainer" class="w3-right w3-padding-16">
    <div id="mypagediv" style="display: none;"></div>
      ...
      <a id="w3loginbtn" class="w3-bar-item w3-btn w3-right" href="https://profile.w3schools.com/log-in?redirect_url=https%3A%2F%2Fmy-learning.w3schools.com" target="_self" style="display: inline;">Log in</a>
  </div>
  ...
  <div class="w3-right w3-padding-16">
    ...
    <a class="w3-bar-item w3-button bar-item-hover w3-right w3-hide-small barex ws-pink" style="xwidth: 93px; border-radius: 25px; margin-right: 8px;" href="https://www.w3schools.com/spaces" target="_blank" onclick="ga('send', 'event', 'spacesFromTopnavDefault', 'click');" title="Get Your Own Website With W3shools Spaces">Website <span class="ribbon-topnav ws-hide-1100">NEW</span></a>
  </div>
...
<nav id="nav_tutorials" class="w3-hide-small navex" style="position: absolute; background-color: rgb(40, 42, 53); color: white; padding-bottom: 60px; display: none;">
 <div class="w3-content" style="max-width:1100px;font-size:18px">
 <span onclick="w3_close_nav('tutorials')" class="w3-button w3-xxxlarge w3-display-topright w3-hover-white" style="padding-right:30px;padding-left:30px;">×</span><br>
...
<nav id="nav_references" class="w3-hide-small navex" style="position: absolute; background-color: rgb(40, 42, 53); color: white; padding-bottom: 60px; display: none;">
 <div class="w3-content" style="max-width:1100px;font-size:18px">
 <span onclick="w3_close_nav('references')" class="w3-button w3-xxxlarge w3-display-topright w3-hover-white" style="padding-right:30px;padding-left:30px;">×</span><br>
 <div class="w3-row-padding w3-bar-block">
 <div class="w3-container" style="padding-left:13px">
...
<nav id="nav_exercises" class="w3-hide-small navex" style="position: absolute; background-color: rgb(40, 42, 53); color: white; padding-bottom: 60px; display: none;">
 <div class="w3-content" style="max-width:1100px;font-size:18px">
 <span onclick="w3_close_nav('exercises')" class="w3-button w3-xxxlarge w3-display-topright w3-hover-white" style="padding-right:30px;padding-left:30px;">×</span><br>
 <div class="w3-row-padding w3-bar-block">
 <div class="w3-container" style="padding-left:13px">
...
<div class="w3-content" style="max-width:1400px">
 ...
 <div class="w3-col l6 w3-center" style="padding:3%;">
  ...
  <a href="/tags/default.asp" class="w3-button ref-button">HTML Reference</a>
  </div>
...
<div class="w3-row w3-padding-32 ws-light-green">
<div class="w3-content" style="max-width:1400px">
 <div class="w3-col l6 w3-center" style="padding:3%">
 ...
 <div class="w3-col l6" style="padding:3%">
  <div class="w3-hide-small grey-color w3-card-2 w3-round" style="padding:16px;">
  <h3>CSS Example:</h3>
  <div class="w3-code cssHigh notranslate green-border"><span class="cssselectorcolor" style="color:brown">
...
&nbsp; text-align<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> center<span class="cssdelimitercolor" style="color:black">;</span></span><br></span><span class="cssdelimitercolor" style="color:black">}</span></span></div>
...
<div class="w3-content" style="max-width:1400px">
 <div class="w3-col l6 w3-center" style="padding:3%">
  ...
  <a href="/jsref/default.asp" class="w3-button w3-block ref-button black-color">JavaScript Reference</a>
 </div>
 <div class="w3-col l6" style="padding:3%">
...
<div class="w3-content" style="max-width:1400px">
 <div class="w3-col l6 w3-center" style="padding:3%">
  ...
  <a href="/python/python_reference.asp" class="w3-button w3-block ref-button">Python Reference</a>
 </div>
 <div class="w3-col l6" style="padding:3%">
  <div class="w3-hide-small w3-card-2 grey-color w3-round" style="padding:16px;">
  <h3>Python Example:</h3>
  <div class="w3-code jsHigh notranslate green-border" style="height:180px"><span class="jscolor" style="color:black"><span class="jsnumbercolor" style="color:red">
...
<div class="w3-content" style="max-width:1400px">
 ...
 <div class="w3-col l6" style="padding:3%">
  <div class="w3-hide-small w3-card-2 grey-color w3-round" style="padding:16px;">
  <h3>SQL Example:</h3>
  <div class="w3-code sqlHigh notranslate green-border" style="height:180px"><span class="sqlcolor" style="color:black"><span class="sqlnumbercolor" style="color:">
...
</span>   <span class="sqlkeywordcolor" style="color:mediumblue">WHERE</span> Country=<span class="sqlstringcolor" style="color:brown">'Mexico'</span>;<span class="sqlnumbercolor" style="color:">
</span>  </span></div>
...
<footer class="w3-container w3-center w3-padding-32 ws-black">
 <div class="w3-container w3-padding-32">
   ...
   <a class="w3-button w3-white w3-hide-small w3-round w3-hide-medium w3-left" href="/spaces/index.html" target="_blank" style="font-size:17px;margin-top:-9px;margin-left:12px" onclick="ga('send', 'event', 'spacesFromBottomNavDefault', 'click');" title="Get Your Own Website With W3shools Spaces">SPACES</a>
 ...
 <a href="/about/about_copyright.asp" class="w3-hover-text-green">Copyright 1999-2021</a> by Refsnes Data. All Rights Reserved.<br><br></p>
